...
public final class ContentTypeInstrumentItem extends Item
{
	...
	static final MediaImageMagickFilter allToOne = new MediaImageMagickFilter(all, new IMOperation()).outputContentType(MediaType.JPEG);
	static final MediaImageMagickFilter oneToAll = new MediaImageMagickFilter(one, new IMOperation());
	static final MediaImageMagickFilter oneToOne = new MediaImageMagickFilter(one, new IMOperation()).outputContentType(MediaType.JPEG);
	...
	{
		return all.getContentType(this);
	}
	 ...
	 **
	 * Returns the content type of the media {@link #oneToAll}.
	 * @cope.generated This feature has been generated by the cope instrumentor and will be overwritten by the build process.
	 *       It can be customized with the tag <tt>@cope.getContentType public|package|protected|private|none|non-final</tt> in the comment of the field.
	 */
	final java.lang.String getOneToAllContentType()
	{
		return ContentTypeInstrumentItem.oneToAll.getContentType(this);
	}/**
