...
public final class ThumbnailMagickTestTest extends CopeAssert
{
		...
		throws IOException
	{
		...
		{
			assertStartsWith(
					"org.im4java.core.CommandException: org.im4java.core.CommandException: convert.im6: invalid argument for option `-resize': " + errorMessage + " @ ",
					runtimeException.getMessage());
			final CommandException commandException = (CommandException)runtimeException.getCause();
			assertStartsWith(
					"org.im4java.core.CommandException: convert.im6: invalid argument for option `-resize': " + errorMessage + " @ ",
			...
			assertStartsWith(
					"convert.im6: invalid argument for option `-resize': " + errorMessage + " @ ",
