...
public final class ThumbnailMagickItem extends Item
{
	...
	static final MediaImageMagickThumbnail thumb = new MediaImageMagickThumbnail(file, 20, 30).outputContentType(MediaType.JPEG);
	static final MediaImageMagickThumbnail thumbFull =
			new MediaImageMagickThumbnail(file, 20, 30).
				outputContentType(MediaType.PNG).
				density(300).
				flatten("white");
	static final MediaImageMagickThumbnail thumbSame = new MediaImageMagickThumbnail(file, 20, 30);
